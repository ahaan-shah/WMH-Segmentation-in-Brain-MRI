...
def main() -> None:
    ...
    write_manifest(SWEEP_CSV, generating_script=f"code/segmentation/{SCRIPT_NAME}.py")
    ...
    write_manifest(SUMMARY_CSV, generating_script=f"code/segmentation/{SCRIPT_NAME}.py")
